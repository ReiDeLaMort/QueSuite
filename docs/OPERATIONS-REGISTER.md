...
Further owner direction, September 5, 2026: associates should be able to originate records and identify their sources; all authorized contributors retain credit and change reasons. Reversals and duplicate consolidation must preserve other contributions, historical references, supplier alternatives and purchase outcomes. **REC-007: Decision Exploring / Delivery Not scheduled** while the detailed revision and identity-resolution workflow is defined. This extends REC-001/003/004 and OPS-005/006; see [CONTRIBUTIONS.md](CONTRIBUTIONS.md). Authenticated identity is required before individual authorship is relied on. No actual edit, reversal, merge or purchasing feature is introduced by this register update.

Owner clarification, September 5, 2026: the company website screenshot was a visual reference for customizable company branding and layouts that feel familiar to employees. **REC-008: Decision Exploring / Delivery Not scheduled**. Company defaults, department views and personal preferences are proposed in [COMPANY-APPEARANCE.md](COMPANY-APPEARANCE.md). Appearance changes preserve record meanings, links, permissions and readable operation across devices; the concept does not implement company settings or change beta access.
...
| REC-007 | Contribution credit, revisions and consolidation | Creator/contributors distinct from source providers/reviewers; field/relationship sources and reasons; competing proposals, version checks, explained reversals, merge decisions/aliases and reviewed splits. Preserve history, access boundaries, supplier alternatives and legitimate transactions. |
| REC-008 | Company appearance and personal workspaces       | Company branding/layout defaults, department views and personal preferences with clear inheritance; scoped preview/publication/reset, accessible palettes, responsive layouts and explained shared revisions. Preserve record meanings, links and access independently of appearance.                 |
